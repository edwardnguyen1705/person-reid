...
def drop_path(x, drop_prob: float = 0.0, training: bool = False):
    """Copied from https://github.com/rwightman/pytorch-image-models/blob/54a6cca27a9a3e092a07457f5d56709da56e3cf5/timm/models/layers/drop.py#L14
